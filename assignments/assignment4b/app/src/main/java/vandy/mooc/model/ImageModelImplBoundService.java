...
public class ImageModelImplBoundService 
    ...
    protected void bindService() {
        ...
        if (mRequestMessengerRef == null) {
            ...
            // user.
            // TODO - you fill in here.
            final Intent downloadIntent = DownloadImagesBoundService
                    .makeIntent(mImagePresenter.get().getApplicationContext());
            ...
            // TODO -- you fill in here.
            mImagePresenter.get().getActivityContext().bindService(downloadIntent,
